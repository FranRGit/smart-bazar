...
def render_html(html_str):
    """Renderiza HTML en Streamlit empaquetando las líneas y eliminando sangrías y saltos en blanco para evitar que Markdown genere bloques de código (<pre><code>)."""
